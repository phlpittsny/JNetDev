 ...
 *
 * Wrapper class for a 2-byte integer ... similar to Short.
 */
package jNetDev;
...
public class jND_BYTE2 {
	...
	public jND_BYTE2(long b) {
		v_short = (short) (b & 0xffff);
	}
	...
	public int toInt() {
		return ((int) v_short) & 0xffff;
	}
	
	public long toLong() {
		return ((long) v_short) & 0xffff;
	}
